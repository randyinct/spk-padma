    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('alternatif.update', $data->id ) }}">
            ...
            <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary mt-4">Update Alternatif</button>
                <a href="{{ route('alternatif.index') }}" class="btn btn-danger mt-4">Batal</a>
                </form>
            </div>
        </div>
@endsection